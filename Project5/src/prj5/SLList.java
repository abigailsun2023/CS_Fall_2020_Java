...
/**
 * This class is a singly linked list with iterator and insertion sort.
 *
...
public class SLList<E> implements Iterable<E> {
    /**
     * This class can iterate through a singly linked list
     * 
     * @author Mithran Mohanraj (mithran)
     * @version 2020.11.21
     * @param <E>
     *            Class this iterator handles
     */
    private class SLListIterator<A> implements Iterator<E> {
         ...
         */
        public SLListIterator(SLList<E> list) {
            current = list.head;
        }
        ...
        public E next() {
            if (!hasNext()) {
                throw new NoSuchElementException(
                    "List given has no more elements");
            }
